"""
Primary productivity data fetcher.
...
async def fetch_pp(
    ...
    """
    Fetch primary productivity data from ERDDAP.

    Args:
        dataset_id: ERDDAP dataset ID (e.g. 'erdMH1pp8day')
        bbox: [lon_min, lon_max, lat_min, lat_max]
        date_start: ISO date string 'YYYY-MM-DD'
        date_end: ISO date string 'YYYY-MM-DD'

    Returns:
        xarray.Dataset with primary productivity variable
    """
